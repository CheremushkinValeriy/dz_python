# >>>>>>>>>>здесь бедет функция для запуска функци с контролера
import controller
controller.start()
...
# Строка содержит id,имя,фамилию,номер телефона, комментрий - символ разделитель
# на выбор(можно использовать пробел или запятые) + файл с хранением этих строк
